...
import { supabase, DEPARTMENTS, getSubjectsForDepartmentSemester } from '@/lib/supabase'
  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    try {
      ...
      if (isNaN(semesterNum) || semesterNum < 1 || semesterNum > 8) {
        setError('Semester must be between 1 and 8.'); return
      }
      const subjects = getSubjectsForDepartmentSemester(form.department, semesterNum)
